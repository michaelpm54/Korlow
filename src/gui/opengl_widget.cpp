...
void OpenGLWidget::createGLObjects()
{
	destroyGLObjects();
...
void OpenGLWidget::destroyGLObjects()
{
	if (mProgram)
	{
...
void OpenGLWidget::update(const uint8_t* data)
{
	glBindTexture(GL_TEXTURE_2D, mFrameTexture);
...
void OpenGLWidget::updateMap(const uint8_t* data)
{
	glBindTexture(GL_TEXTURE_2D, mMapTex);
